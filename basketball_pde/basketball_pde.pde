...
void setup()
{
  ...
  //PROCESS DATA
  gamestable = loadTable("/nba1/games.csv", "header"); // list of games
  ...
  teamstable = loadTable("/nba1/team.csv", "header");           // list of teams
  ...
  playerstable = loadTable("/nba1/players.csv", "header");       // list of teams
